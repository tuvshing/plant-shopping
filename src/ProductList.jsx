...
function ProductList() {
    ...
    const handleCartClick = () => {
        console.log('cart')
        setShowCart(true); // Show the cart when the cart button is clicked
    };

    const handleCloseCart = () => {
        setShowCart(false); // Hide the cart when the close button is clicked (you'll need to add a close button to your Cart component)
    };
    return (
      <div>
        ...
        {showCart && <Cart onContinueShopping={handleCloseCart} />} 
        </div>
    );
}
